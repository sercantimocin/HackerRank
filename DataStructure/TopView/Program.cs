...
//    HashMap<Integer, Integer> topView = new HashMap<Integer, Integer>();

//    if (root != null)
//    {
//        topView.put(0, root.data);
//    }


//    OrderalTraversal(root, 0, topView);

//    for (Map.Entry<Integer, Integer> item : topView.entrySet())
//    {
//        System.out.print(item.getValue() + " ");
//    }
//}

//void OrderalTraversal(Node root, int depth, HashMap<Integer, Integer> topView)
//{
//    if (root != null)
//    {
//        int leftDepth = depth - 1;
...
//        if (leftNode != null && !topView.containsKey(leftDepth))
//        {
//            topView.put(leftDepth, leftNode.data);
//        }
...
//        if (rightNode != null && !topView.containsKey(rightDepth))
//        {
//            topView.put(rightDepth, rightNode.data);
//        }
